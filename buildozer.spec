...
requirements = hostpython3==3.11.0, python3==3.11.0, kivy, opencv, pyjnius
...
android.permissions = CAMERA, RECORD_AUDIO, WRITE_EXTERNAL_STORAGE, READ_EXTERNAL_STORAGE, FOREGROUND_SERVICE
...
requirements = hostpython3==3.11.0, python3==3.11.0, kivy, opencv, pyjnius, charset_normalizer
